...
```shell
go get github.com/sparkymat/godotenv
```

or if you want to use it as a bin command
```shell
go get github.com/sparkymat/godotenv/cmd/godotenv
```
...
```go
import _ "github.com/sparkymat/godotenv/autoload"
```
...
Use [annotated tags for all releases](https://github.com/sparkymat/godotenv/issues/30). Example `git tag -a v1.2.1`
